...
| [CodeGraph](https://github.com/Abhishek-Aditya-bs/CodeGraph) | Turns any Python codebase into a queryable Neo4j knowledge graph — AST parsing extracts functions, classes, and their dependencies, LLMs describe each in plain English, and you explore it all through natural-language queries over an interactive graph UI. | Python · Neo4j · LangChain · Flask | — |
